...
<div class="container-fluid p-0">
    <div class="row">
        ...
        <div class="col-md-6">
            <a href="{{ url("/penerimaan") }}" style="float: right;" class="btn btn-warning"><i class="align-middle" data-feather="chevrons-left"></i>&nbsp;Back</a>
        </div>
    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="my-2 row">
                                                <label for="quantity" class="col-sm-6">No Pembelian*</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="my-2 row">
                                                <label for="quantity" class="col-sm-6">Nama Supplier*</label>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" placeholder="Nama Supplier" id="nama_supplier" readonly>
                                                </div>
                                            </div>
                                            <div class="my-2 row">
                                                <label for="tanggal_pmbelian" class="col-sm-6">Tanggal Pembelian*</label>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" placeholder="Tanggal Pembelian" id="tanggal_pembelian" name="tanggal_pembelian" readonly>
                                                </div>
                                            </div>
                                            <div class="my-2 row">
                                                <label for="total_produk" class="col-sm-6">Total Produk*</label>
                                                <div class="col-sm-6">
                                                    <input type="number" class="form-control" id="total_produk" name="total_produk" value="0" readonly>
                                                </div>
                                            </div>
                                            <div class="my-2 row">
                                                <label for="nama_karyawan_pembelian" class="col-sm-6">Nama Karyawan*</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="mb-2 mt-2 row">
                                                <label for="total_keseluruhan" class="col-sm-6">Total Keseluruhan*</label>
                                                <div class="col-sm-6">
                                                    <input type="number" class="form-control" placeholder="Total Harga" id="total_keseluruhan" name="total_total_keseluruhanarga" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
